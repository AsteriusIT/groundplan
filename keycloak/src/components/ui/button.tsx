...
// Ported from apps/frontend/src/components/ui/button.tsx. This theme is
// dark-only, so the frontend's `dark:` variants are baked in as the plain
// classes here (no `dark:` prefix, no `.dark` wrapper to depend on).
