...
/**
 * GP-89: one NSG / route table pinned to the subnet header as a chip. The chip
 * *is* the node — clicking it opens the node's detail panel (rules, exposure) —
 * so its status shows as a dot and it is reachable by keyboard.
 */
function SubnetChip({
  node,
  highlighted = false,
